...
<%-- 
	 <button  class="button" style="float: right;"> <a href="<s:url action="verifyaction"/>">HOME</a></button>	 --%>
        <h2 align="center">STATISTICS OF PASSENGER APPORTIONMENT FOR ALL INDIAN RAILWAYS (PRS)  </h2>
				...
				<table width="100%" border="2px">
					...
					<s:iterator value="dataList">
						...
						<%-- 	<td align="center"><s:property value="isafetycharges" /></td> --%>
							...
							<td align="center"><s:property value="ucatgchg" /></td>
					...
					<%-- <td align="center"><s:property value="sum13" /></td> --%>
					 <td align="center" style="font-weight:bold"><s:property value="sum14" /></td>
					 <td align="center" style="font-weight:bold"><s:property value="sum15" /></td>
