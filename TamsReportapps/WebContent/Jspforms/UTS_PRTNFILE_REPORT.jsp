...
<div >
	<s:form name="tamsform" id="tamsform" action="" method="post">
     ...
     <h2 align ="center">UTS PRTNFILE REPORT  </h2>
      <h3 align = "center" > <s:property value="FullZoneName" /></h3>
     <h3 align = "center"  >Passenger Apportionment of UTS for the month of  <s:property value="tamsmonth " /> - <s:property value=" tamsrpt" /> </h3>
