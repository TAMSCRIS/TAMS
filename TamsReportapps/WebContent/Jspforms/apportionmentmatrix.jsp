...
<body >
	<s:form name="tamsform" id="tamsform" action="" method="post">
     ...
     <h2 align ="center">SUMMARY OF PASSENGER APPORTIONMENT FOR ALL INDIAN RAILWAYS (PRS) </h2>
     ...
     <h3 align = "right">Figures in 000s</h3>
			...
			<div>
				<table width="100%" border="2px">
				  ...
				  <p align="center"  style="font-weight:bold"> Note 2- Catering charges have not been included in apportioned share of railways.   </p>
